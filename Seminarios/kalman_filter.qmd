...
$$
(1 + \theta_1L + \theta_2L^2 + \ldots + \theta_{r-1}L^{r-1})(y_t - \mu) = (\phi_1 + \phi_2L + \phi_3L^2 + \ldots + \phi_rL^{r-1})\epsilon_t
$$
...
$$
\hat\xi_{t+1|t} = \mathbf{F}\xi_{t|t} + \mathbf{0} \\
...
$$
\mathbf{P}_{t|t+1} = \mathbf{F}\mathbf{P}_{t|t}\mathbf{F}' + \mathbf{Q} \\
